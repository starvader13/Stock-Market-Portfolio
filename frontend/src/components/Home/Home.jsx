...
export default function Home(){
    ...
    const [homeDescriptionId, setHomeDescriptionId] = useState(null);

    const selectDescription = (id) =>{
        homeDescriptionId === id ? setHomeDescriptionId(null) : setHomeDescriptionId(id);
    }
        ...
        <Header/>
        {
            allStocks.map((stock, index)=>{
                ...
                return <StockComponent
                    ...
                    price={stock.price}
                    symbol={stock.symbol}
                    watchlist={userSignedIn ? stock.watchlist : false}
                    description={stock.description}
                    selectDescription={selectDescription}
                    descriptionId={homeDescriptionId}/>
            })
        }
    </div>
}
